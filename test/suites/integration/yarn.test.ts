...
describe('Test svecchia function', function () {
    ...
    describe('Tests with package.json without dependencies', function () {
        ...
        it('Should work with default options', async function () {
            await svecchia({ packageManager: 'yarn', path: assetsPath });
        ...
        it('Should work with only prod deps', async function () {
            await svecchia({ packageManager: 'yarn', path: assetsPath, onlyProdDeps: true });
        ...
        it('Should work with only dev deps', async function () {
            await svecchia({ packageManager: 'yarn', path: assetsPath, onlyDevDeps: true });
        ...
        it('Should work with only peer deps', async function () {
            await svecchia({ packageManager: 'yarn', path: assetsPath, onlyPeerDeps: true });
        ...
        it('Should work with only optional deps', async function () {
            await svecchia({ packageManager: 'yarn', path: assetsPath, onlyOptionalDeps: true });
        ...
        it('Should work with clean cache activated', async function () {
            await svecchia({ packageManager: 'yarn', path: assetsPath, cleanCache: true });
        ...
        it('Should work with exclude and with only', async function () {
            await svecchia({ packageManager: 'yarn', path: assetsPath, exclude: ['a', 'b'], only: ['b', 'c'] });
    ...
    describe('Tests with package.json without prod dependencies', function () {
        ...
        it('Should work with default options', async function () {
            ...
            expect(mockExecuteAsync).toHaveBeenCalledTimes(1);
            expect(mockExecuteAsync).toHaveBeenCalledWith('yarn remove a b c && yarn add --dev a b c', {
                cwd: assetsPath
            });

            expect(mockEuberlogInfo).toHaveBeenCalledTimes(1);
            expect(mockEuberlogInfo).toHaveBeenCalledWith('yarn remove a b c && yarn add --dev a b c');
        ...
        it('Should work with exclude and with only', async function () {
            ...
            expect(mockExecuteAsync).toHaveBeenCalledTimes(1);
            expect(mockExecuteAsync).toHaveBeenCalledWith('yarn remove c && yarn add --dev c', {
                cwd: assetsPath
            });

            expect(mockEuberlogInfo).toHaveBeenCalledTimes(1);
            expect(mockEuberlogInfo).toHaveBeenCalledWith('yarn remove c && yarn add --dev c');
